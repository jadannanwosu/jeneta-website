...
knit: (function(inputFile, encoding) {
  ...
  output_dir = "~/jeneta-website/_projects") })
layout: post
...
base_dir <- "~/jeneta-website/" # i.e. where the jekyll blog is on the hard drive.
base_url <- "/" # keep as is
...
if (!is.null(knitr::current_input())){
  ...
  fig_path <- paste0("_projects/fig/", str_remove(knitr::current_input(), ".Rmd"), "/")
